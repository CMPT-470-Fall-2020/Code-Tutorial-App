...
export default class Post extends Component {
  ...
  updatePost() {
    ...
    document.getElementById(
      "title"
    ).innerHTML = `Title: ${this.state.editTitle}`;
  ...
  updateComment(comment) {
    axios({
      ...
      document.getElementById(
        comment._id
      ).firstChild.innerHTML = this.state.editComment;
      ...
      axios
        ...
        .then((res) => {
          ...
          deleteBtn.addEventListener(
            "click",
            this.deleteComment.bind(this, newComment)
          );
          ...
          editBtn.addEventListener(
            "click",
            this.editComment.bind(this, newComment)
          );
    ...
    return (
      <React.Fragment>
        <div style={centerLayout}>
          ...
          <main style={main}>
            <h5>
              <b id="title">Title: {this.state.forum.postTitle}</b>
            </h5>
